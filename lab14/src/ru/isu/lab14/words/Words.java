...
public class Words {
    ...
    public static List<String> withoutDefis(final List<String> dictionary) {
        ...
        //TODO выбираем из словаря те слова, которые не содержат символ дефиса. Добавляем их в результирующий список ret
    ...
    public static int countUserWord(final int oldCount, final String userWord) {
    ...
    public static int countCompWord(final int oldCount, final String compWord) {
        //Слово ДОМ длины 3. Общий счет компьютера равен 25
        //длина слова
        int wordLength = 0; //TODO
        //новый счет
        int newCount = 0; //TODO
        System.out.printf("Слово %s длины %d. Общий счет компьютера равен %d\n", compWord, wordLength, newCount);
        return newCount;
    }
    ...
    public static void main(String[] args) {
         ...
         * Организовываем игру. Будем предлагать пользователю ввести слово. Затем компьютер вводит слово. По очереди.
          ...
          * На каждом ходу пользователю разрешается 10 ошибок. Если 10 раз ввел слово, которого нет в словаре, игра останавливается.
         */
        ...
        while(userErrors < MAX_ERRORS){
            ...
            if(!validDic.contains(userWord)){
                ...
                userCount = countUserWord(userCount, userWord);
            }
            ...
            compCount = countCompWord(compCount, compWord);
        }
